...
CASES = [{'tables': {'city': (['city_id', 'name'], [[1, 'New York'], [2, 'New Delhi'], [3, 'Berlin']]), 'accounts': (['account_id', 'account_name', 'account_type', 'city_id'], [[1, 'Nelson', 'Savings', 1], [2, 'Mohit', 'Current', 2], [3, 'Rachel', 'Savings', 1], [4, 'David', 'Savings', 3], [5, 'Roger', 'Current', 1]]), 'transactions': (['transaction_id', 'account_id', 'transaction_type', 'amount', 'date'], [[1, 1, 'Credit', 1000, '2017-05-27'], [2, 1, 'Credit', 200, '2017-05-02'], [3, 3, 'Credit', 1500, '2017-05-27'], [4, 2, 'Savings', 362, '2017-05-27'], [5, 3, 'Credit', 1700, '2017-05-21']])}, 'expected': [[4762]]}, {'tables': {'city': (['city_id', 'name'], [[1, 'Berlin'], [2, 'Helsinki'], [3, 'Paris']]), 'accounts': (['account_id', 'account_name', 'account_type', 'city_id'], [[1, 'Roger', 'Savings', 1], [2, 'Rita', 'Current', 2], [3, 'Michael', 'Savings', 1], [4, 'David', 'Savings', 3], [5, 'Roger', 'Current', 1]]), 'transactions': (['transaction_id', 'account_id', 'transaction_type', 'amount', 'date'], [[1, 1, 'Credit', 1000, '2017-05-27'], [2, 1, 'Credit', 200, '2017-01-02'], [3, 3, 'Credit', 1500, '2017-01-27'], [4, 2, 'Savings', 362, '2017-01-27'], [5, 3, 'Credit', 1700, '2017-05-21']])}, 'expected': [[2700]]}]
